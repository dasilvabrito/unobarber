    ...
    <header className="fixed top-0 w-full z-50 bg-salon-black/90 backdrop-blur-md border-b border-salon-brown/50 transition-all duration-300">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          {socials.whatsapp && (
            <a href={`https://wa.me/${socials.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-salon-beige hover:text-green-500 transition-colors" title="WhatsApp">
